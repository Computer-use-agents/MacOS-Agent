...
from macosagent.agents.textedit_agent.textedit_agent.computeruse_tool.agent_utils import parsing_response_to_pyautogui_code 
from macosagent.agents.textedit_agent.textedit_agent.computeruse_tool.get_accessibility_tree import GetTree
from macosagent.agents.textedit_agent.textedit_agent.computeruse_tool.draw_accessibility_tree import DrawTree
...
class ComputerControl(Tool):
    ...
    def forward(self, subgoal):
        try:
            [screenshot_path, accessibility_tree_path] = self.get_tree.forward('文本编辑')
            [highlighted_screenshot_path, element_bbox_path] = self.draw_tree.forward('文本编辑', screenshot_path, accessibility_tree_path)
        except:
            try:
                [screenshot_path, accessibility_tree_path] = self.get_tree.forward('TextEdit')
                [highlighted_screenshot_path, element_bbox_path] = self.draw_tree.forward('TextEdit', screenshot_path, accessibility_tree_path)
