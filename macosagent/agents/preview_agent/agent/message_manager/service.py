...
class MessageManager:
    ...
    def _init_messages(self) -> None:
        ...
        self.add_tool_message(content="Click success!")
    ...
    def get_messages(self) -> list[BaseMessage]:
        ...
        for m in self.state.history.messages:
            ...
            logger.debug(
                f"{m.message.__class__.__name__} - Token count: {m.metadata.tokens}"
            )
    ...
    def _add_message_with_tokens(
        self, message: BaseMessage, position: int | None = None
    ) -> None:
    ...
    def _count_text_tokens(self, text: str) -> int:
        ...
        tokens = (
            len(text) // self.settings.estimated_characters_per_token
