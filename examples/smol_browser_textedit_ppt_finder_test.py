...
def main():
    ...
    parser.add_argument(
        ...
        default="Search for Pushkin's poem 'If life deceives you', write it to './cache/poem.txt', and then according to the content in the file to create a pretty powerpoint in './cache/poem.pptx', and finally copy the genetated powerpoint to './data'.",
